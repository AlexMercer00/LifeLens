...
import { Dna, Microscope, FlaskConical, ExternalLink } from 'lucide-react'
        ...
        <div className="grid gap-4 md:grid-cols-2">
          {genes.map((gene) => (
            <Card key={gene.id} className="hover:shadow-lg transition-shadow">
              ...
              <CardFooter>
                <Link href={`/genes/${gene.id}`} className="ml-auto">
        ...
        <div className="grid gap-4 md:grid-cols-2">
          {compounds.map((compound) => (
            <Card key={compound.id} className="hover:shadow-lg transition-shadow">
              ...
              <CardFooter>
                <Link href={`/compounds/${compound.id}`} className="ml-auto">
                  <Button variant="outline" size="sm">
                    <FlaskConical className="h-4 w-4 mr-2" />
                    View Details
                  </Button>
